...
@interface NTESSelectViewController ()<NSTextFieldDelegate, NIMConversationManagerDelegate>
...
- (void)viewDidLoad {
    ...
    NSArray *arrar = [[NIMSDK sharedSDK].conversationManager.allRecentSessions mutableCopy];
    NSLog(@"%@::::::::::", arrar);
}

#pragma mark - NIMConversationManagerDelegate
-(void)didAddRecentSession:(NIMRecentSession *)recentSession totalUnreadCount:(NSInteger)totalUnreadCount {
    NSLog(@"____%@:%d", recentSession, totalUnreadCount);
}
